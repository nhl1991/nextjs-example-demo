...
export default function Page() {
  const copyRef = useRef<HTMLElement | HTMLParagraphElement | null>(null);
          ...
          <>
            ...
            <button
              className={`px-2 border-2 rounded-xl ${
                mode ? "border-lime-500" : "border-red-500"
              }`}
        ...
        <div className="w-1/2 flex border-2 border-gray-400 rounded-2xl">
          {mode ? (
            <input
              ...
              ref={copyRef as React.RefObject<HTMLInputElement>}
              placeholder="Type something here and copy it."
            />
          ) : (
            <p
